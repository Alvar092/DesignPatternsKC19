...
final class LoginViewModelTests: XCTestCase {
    ...
    func testWhenUseCaseFailsStateRemainsError() {
        let useCase = FailedLoginUseCase()
        let sut = LoginViewModel(useCase: useCase)
        ...
        XCTAssertEqual(lastState, .error(reason: expectedText), "El estado debería seguir siendo error.")
    }
